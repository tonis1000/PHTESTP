...
// 🔥 Ανανεasync function playStream(initialURL, subtitleURL = null) {
  ...
  // ... (το υπόλοιπο playStream() όπως το έχεις)

  // ✅ Μην ξεχάσεις να βάλεις:
  // window._currentlyPlaying = null;
  // στο τέλος του try/finally όπως ήδη έχεις κάνει
}
ωμένο playStream
